<template>
  <q-page class="flex flex-center">
    <h1>Autoscheduler</h1>
    <q-btn flat dense round aria-label="Add Event" @click="addEvent()" />
  </q-page>
</template>
...
function addEvent() {
  ...
  const connectscripts = require("C:\\Users\\21angtor\\OneDrive - ABB Industrigymnasium\\Te\\Autoscheduler\\Scripts\\koppling.js");
...
// import { addEvent } from "http://localhost:8081/Scripts/AddEvent.js";
defineOptions({
  name: "IndexPage",
});
// function test() {
//   console.log("works yay!!!!!!!!!!S");
// }
</script>
<!-- <script src="../../../Scripts/AddEvent.js"></script> -->
